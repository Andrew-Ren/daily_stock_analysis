...
| [EntityLink 与跨页面动作模型](entity-link-actions.md) | stock、index、sector、concept、strategy、report、signal、alert、portfolio_position、calendar_event 的统一 ref、跳转动作、pending 路由和复用边界 |
