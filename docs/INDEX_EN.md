...
| [Calendar Event API](calendar-events.md) <sub><sub>![P1 Badge](https://img.shields.io/badge/P1-yellow?style=flat)</sub></sub> (Chinese-only) | Shared event model, upcoming/symbol queries, explicit external coverage status, and phase boundaries |
