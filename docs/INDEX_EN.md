...
| [EntityLink And Cross-page Actions](entity-link-actions.md) (Chinese-only) | Stable entity references, fail-closed action availability, target-context requirements, and integration boundaries |
