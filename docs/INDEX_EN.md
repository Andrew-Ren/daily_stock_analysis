...
| [EntityLink And Cross-page Actions](entity-link-actions.md) <sub><sub>![P8 Badge](https://img.shields.io/badge/P8-orange?style=flat)</sub></sub> (Chinese-only) | Stable entity references, fail-closed action availability, target-context requirements, and integration boundaries |
