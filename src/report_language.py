...
def normalize_strategy_synthesis_payload(value: Any) -> Dict[str, Any]:
    ...
    applied_weights = [opinion.get("applied_weight") for opinion in opinions]
    ...
    reconciled_consensus_level = derive_strategy_consensus_level(
        ...
        strategy_conflicts,
        final_signal,
        insufficient_evidence=has_complete_weights and sum(numeric_weights) <= 0.0,
    )
